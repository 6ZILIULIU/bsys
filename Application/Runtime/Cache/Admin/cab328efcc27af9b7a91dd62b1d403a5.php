    ...
    .progress > div {
            ...
            $("#confirm").dialog({
                ...
                buttons:[{text:'删除',
                        ...
                        $.ajax({
                            ...
                            success:function(r){
                                console.log('good');
                                $(location).attr('href','/bsys/index.php/Admin/Manage/seriesManage');
        ...
        function showProcessBar(){
            ...
            if(formData.get('video') == 'undefined'){
                ...
                $.ajax({
                    url:"/bsys/index.php/Admin/Manage/add_video",
                    data:formData,
                    dataType:'json',
                    type:'post',
                    processData:false,
            ...
            $("#confirm").dialog({
                ...
                buttons:[{text:'删除',
                         handler:function(){
                            ...
                            $.ajax({
                                type:'post',
                                url:"/bsys/index.php/Admin/Manage/remove_video",
        ...
        function showDetail(){
            ...
            $.ajax({
                type:'post',
                dataType:'json',
                url:"/bsys/index.php/Admin/Manage/getVideosData",
                data:{series_id:series_id,userName:userName},
                success:function(r){
        ...
        function uploadchangeCover(){
            ...
            if(formData.get('newCover') == 'undefined'){
                ...
                $.ajax({
                    url:"/bsys/index.php/Admin/Manage/changeCover",
                    data:formData,
                    dataType:'json',
                    type:'post',
                    async: false,
        ...
        function changeShelves(){
            $.ajax({
                url:"/bsys/index.php/Admin/Manage/change_shelves",
                type:'post',
                dataType:'json',
                data:{userName:userName,series_id:series_id},
                success:function(r){
        ...
        function uploadchangeTitle(){
            ...
            $.ajax({
                url:"/bsys/index.php/Admin/Manage/change_title",
                type:'post',
                dataType:'json',
...
<!-- /bsys/index.php/Admin/Manage/add_video -->
<!-- 添加视频 -->
